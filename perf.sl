...
# TODO
# prumer pro ref je v sum[ref]
# prumer pro ostatni je v sum[cislo threadu, nazev buildru]
# ja pouzivam pro vypocty bc, protoze to umi desetina cisla (aby to s nema pocitalo je treba pridat "scale=2;" (viz vyse))
